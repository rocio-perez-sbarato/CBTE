...
from scraping.telefonia_personal import obtener_primer_plan_telefonia_personal
from scraping.telefonia_movistar import obtener_primer_plan_telefonia_movistar
from scraping.telefonia_claro import obtener_primer_plan_telefonia_claro
